...
void Board::resizeBoard(int row, int col){
    ...
    if(row == minRowSize && maxRowSize < MAX_BOARD_DIMENSION - 1){
        ...
        if(col == minColSize && maxColSize < MAX_BOARD_DIMENSION -1){
            addColLeft(row, col);
        }
...
void Board::addRowAbove(int row, int col){
    int minRowSize = 0;
    int minColSize = 0;
    int maxRowSize = getVerticalSize() - 1;
    int maxColSize = getHorizontalSize() - 1;
...
void Board::addRowBelow(int row, int col){
    int maxColSize = getHorizontalSize() - 1;
...
void Board::addColLeft(int row, int col){
    int minRowSize = 0;
    int minColSize = 0;
    int maxRowSize = getVerticalSize() - 1;
    int maxColSize = getHorizontalSize() - 1;
...
void Board::addColRight(int row, int col){
